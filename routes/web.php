...
//----------------Delivery Slot----------------------------------
	...
	Route::get('admin/storereports/shiftdayreport/{storeid}', 'Admin\StoreReportsController@shiftdayreport');
	Route::get('admin/storereports/shiftreport/{shiftid}', 'Admin\StoreReportsController@shiftreport');
