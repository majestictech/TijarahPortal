...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
	...
	<div class="ms-auto">
	    @if(helper::checkUserRights('subscriptionplan_manage','subscriptionplan_add'))
		<div class="btn-group">
								...
								<td>
									<div class="btn-group">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
											@if(helper::checkUserRights('subscription_manage','subscriptionplan_edit'))
											...
											@endif
											@if(helper::checkUserRights('subscription_manage','subscriptionplan_del'))
