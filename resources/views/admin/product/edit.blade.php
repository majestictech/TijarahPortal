	...
	<div class="ps-1">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-0 p-0">
				...
				@endif
				<li class="breadcrumb-item active" aria-current="page"><i class="bx bx-book-content"></i> {{ __('lang.editproduct')}}</li>
			</ol>
		</nav>
	</div>
</div>
		...
		<div class="card border-top border-0 border-4 border-secondary">
			<div class="card-body p-5 ">
				<div class="card-title d-flex align-items-center">
					...
					<h5 class="mb-0 text-primary">{{ __('lang.editproduct')}}</h5>
				</div>
				<hr>
