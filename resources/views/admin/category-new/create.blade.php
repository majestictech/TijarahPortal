						...
						@csrf
                            <div class="col-md-6 ">
								...
								<div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bx-store'></i></span>
									<input type="text" name="name" class="form-control border-start-0" id="storename" placeholder="{{ __('lang.entercategoryname')}}" />
								</div>
							</div> 
							<div class="col-md-6 ">
								<label class="form-label">{{ __('lang.categoryname_ar')}} *</label>
								<div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bx-store'></i></span>
									<input type="text" name="name_ar" class="form-control border-start-0" placeholder="{{ __('lang.entercategoryname_ar')}}" />
								</div>
							</div> 							
                            <div class="col-md-6 ">
								<label class="form-label">{{ __('lang.categoryname_ur')}} *</label>
								<div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bx-store'></i></span>
									<input type="text" name="name_ur" class="form-control border-start-0" placeholder="{{ __('lang.entercategoryname_ur')}}" />
								</div>
							</div> 
							<div class="col-md-6 ">
								<label class="form-label">{{ __('lang.categoryname_ml')}} *</label>
								<div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bx-store'></i></span>
									<input type="text" name="name_ml" class="form-control border-start-0" placeholder="{{ __('lang.entercategoryname_ml')}}" />
								</div>
							</div>
 							<div class="col-md-6 ">
								<label class="form-label">{{ __('lang.categoryname_bn')}} *</label>
								<div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bx-store'></i></span>
									<input type="text" name="name_bn" class="form-control border-start-0" placeholder="{{ __('lang.entercategoryname_bn')}}" />
								</div>
							</div>
