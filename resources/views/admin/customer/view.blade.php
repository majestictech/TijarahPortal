...
<div class="content-page">
	<div class="container-fluid">
		...
		<div>
						...
						<tr>
							...
							<td>
								...
								href="{{url('/admin/order/'.$sc->orderid.'/view')}}"><i class="ri-eye-line mr-0"></i></a> -->
									<a class="btn view btn-primary" href="{{url('/admin/order/'.$sc->orderid.'/view')}}">
										<i class="bx bx-show"></i></i>
									</a>
								</div>
							</td>
						</tr>
			...
			{{$customerstore->appends(['customersCredit' => $customersCredit->currentPage()])->links()}}   
			
		</div>
		<!-- Customers Credit Start-->
		<div>
			<h4 class="mb-3 mt-3">{{ __('lang.customerscredit')}}</h4>
			<div class="table-responsive rounded mb-3">
				<table class="data-table table mb-0 tbl-server-info">
					<thead class="bg-white text-uppercase">
						<tr class="table-active">
					...
					<tbody class="">
					@foreach($customersCredit as $key => $sc)						
						<tr>
							<td>{{++$key}}</td> 
							<td>{{$sc->orderNumber}}</td>
							<td>SAR {{$sc->balance}}</td>
							<td>{{$sc->type}}</td>
							<!--
							<td>
								...
								href=""><i class="ri-eye-line mr-0"></i></a> 
									<a class="btn view btn-primary" href="">
										<i class="bx bx-show"></i></i>
									</a>
								</div>
							</td>
			...
			{{$customersCredit->appends(['customerstore' => $customerstore->currentPage()])->links()}} 
		</div>
		 <!-- Customers Credit End-->
