			   ...
			   <form action="" method="GET" id ="filter_results">
			    ...
			    <form class="row g-3 pt-3" method="post" action="{{route('userroles.store')}}" data-toggle="validator">
			        ...
			        <div class="col-md-3 pt-5 border-left-0 border-right-0">
						...
						<div class="col-md-12">
                            <input type="checkbox" name="catPermissions[]" value="store_configemail" <?php if(in_array('store_configemail', $permissionArray)){ { echo "checked=''"; } } ?>>
    				...
    				<div class="col-md-3">
    			        ...
    			        <div class="col-md-12">
                            <input type="checkbox" name="catPermissions[]" value="consumers_manage" <?php if(in_array('consumers_manage', $permissionArray)){ { echo "checked=''"; } } ?>>
                            <label for="customer_manage" class="form-label">{{ __('lang.consumers_manage')}}</label><br>
    					</div>
    					<div class="col-md-12">
                            <input type="checkbox" name="catPermissions[]" value="consumers_view" <?php if(in_array('consumers_view', $permissionArray)){ { echo "checked=''"; } } ?>>
                            <label for="customer_view" class="form-label">{{ __('lang.consumers_view')}}</label><br>
    					</div>
    					<div class="col-md-12">
                            <input type="checkbox" name="catPermissions[]" value="consumers_add" <?php if(in_array('consumers_add', $permissionArray)){ { echo "checked=''"; } } ?>>
                            <label for="customer_add" class="form-label">{{ __('lang.consumers_add')}}</label><br>
    					</div>
    					<div class="col-md-12">
                            <input type="checkbox" name="catPermissions[]" value="consumers_edit" <?php if(in_array('consumers_edit', $permissionArray)){ { echo "checked=''"; } } ?>>
                            <label for="customer_edit" class="form-label">{{ __('lang.consumers_edit')}}</label><br>
    					</div>
    					<div class="col-md-12">
                            <input type="checkbox" name="catPermissions[]" value="consumers_del" <?php if(in_array('consumers_del', $permissionArray)){ { echo "checked=''"; } } ?>>
    				...
    				<div class="col-md-3">
						...
						<div class="col-md-12">
                            <input type="checkbox" name="catPermissions[]" value="storetype_del" <?php if(in_array('storetype_del', $permissionArray)){ { echo "checked=''"; } } ?>>
