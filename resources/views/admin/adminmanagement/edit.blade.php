		...
		<div class="card border-top border-0 border-4 border-secondary">
			<div class="card-body p-5 ">
				<div class="card-title d-flex align-items-center">
					...
					<h5 class="mb-0 text-primary">{{ __('lang.editadmin')}}</h5>
				</div>
				<hr>
				<form class="row g-3 pt-3" data-toggle="validator" method="post" action="{{route('adminmanagement.update')}}" >
				@csrf
					<div class="col-md-6 ">
					...
					<div class="col-12">
						...
						<button type="submit" class="btn btn-primary px-5">{{ __('lang.editadmin')}}</button>
