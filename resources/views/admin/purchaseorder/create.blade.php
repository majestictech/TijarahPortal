	...
	<div class="ps-1">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-0 p-0">
				...
				<li class="breadcrumb-item active" aria-current="page"><i class="fadeIn animated bx bx-list-plus"></i> {{ __('lang.addpo')}}</li>
			</ol>
		</nav>
	</div>
</div>
		...
		<div class="card border-top border-0 border-4 border-secondary">
			<div class="card-body p-5 ">
				<div class="card-title d-flex align-items-center">
					...
					<h5 class="mb-0 text-primary">{{ __('lang.addpo')}}</h5>
				</div>
				<hr>
				<form class="row g-3 pt-3" method="post" action="{{route('purchaseorder.store')}}" data-toggle="validator">
				@if($errors->any())
				...
				@csrf
					...
					<div class="col-md-6">
						...
						<div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bx-id-card'></i></span>
							<input type="date" class="form-control border-start-0" name="poDate" id="poDate" required>
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bx-id-card'></i></span>
							<input type="date" class="form-control border-start-0" name="deliveryDate" id="deliveryDate" required>
						</div>
					</div>
                	...
                	<div class="table-responsive">  
						...
						<button type="submit" class="btn btn-primary px-5">{{ __('lang.addpo')}}</button>
					</div>
                    </form>  
                    </div> 
                    </div>
